      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-12 py-5 text-center">
            ...
            <h3 className="mt-4 text-decoration-underline">Discover music in <span className=" text-success ">30</span> seconds!!</h3>
            <h6>Ready to dive into your favorite music?<br />Simply type the name of a song or artist into the search bar above,<br />and let Gaana Bajana bring your tunes to life!</h6>
            <h2 className="mt-4">Start your musical journey now!</h2>
            <h6>Search for your favorite music <strong>Above</strong></h6>
          </div>
        </div>
      </div>
      <div
